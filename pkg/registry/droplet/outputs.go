...
// No omitempty: these replace map[string]any literals, which always
// serialised every key they held. A typed struct is what lets outputSchema
// name those keys; map[string]any only reflects as "object".
type (
