...
var expectedAnnotations = map[string]struct {
	...
	// account_tools.go
	"account-get-information": {true, false, true, false, common.OpRead, common.RiskLow, false, false},
	// action_tools.go
	"action-get":  {true, false, true, false, common.OpRead, common.RiskLow, false, false},
	"action-list": {true, false, true, false, common.OpRead, common.RiskLow, false, false},
	// balance_tools.go
	"balance-get": {true, false, true, false, common.OpRead, common.RiskLow, false, false},
	// billing_tools.go
	"billing-history-list": {true, false, true, false, common.OpRead, common.RiskLow, false, false},
	// invoice_tools.go
	"invoice-list": {true, false, true, false, common.OpRead, common.RiskLow, false, false},
	"get-invoice":  {true, false, true, false, common.OpRead, common.RiskLow, false, false},
	// keys_tools.go
	"key-create": {false, false, false, false, common.OpUpdate, common.RiskLow, false, false},
	"key-delete": {false, true, true, false, common.OpDelete, common.RiskMedium, false, false},
	"key-get":    {true, false, true, false, common.OpRead, common.RiskLow, false, false},
	"key-list":   {true, false, true, false, common.OpRead, common.RiskLow, false, false},
}
...
func TestToolAnnotations(t *testing.T) {
	...
	all = append(all, NewAccountTools(clientFn).Tools()...)
	all = append(all, NewActionTools(clientFn).Tools()...)
	all = append(all, NewBalanceTools(clientFn).Tools()...)
	all = append(all, NewBillingTools(clientFn).Tools()...)
	all = append(all, NewInvoiceTools(clientFn).Tools()...)
	all = append(all, NewKeysTool(clientFn).Tools()...)
